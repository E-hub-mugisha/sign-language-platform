...
<div class="container mt-5">
    ...
    <form action="{{ route('lessons.update', $lesson->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="file" class="form-control" id="video_url" name="video_url" value="{{ old('video_url', $lesson->video_url) }}" required>
        </div>

        <div class="mb-3">
            <label for="pdf_url" class="form-label">PDF URL</label>
            <input type="file" class="form-control" id="pdf_url" name="pdf_url" value="{{ old('pdf_url', $lesson->pdf_url) }}" required>
        </div>

        <div class="mb-3">
            <label for="thumbnail_url" class="form-label">Thumbnail URL</label>
            <input type="file" class="form-control" id="thumbnail_url" name="thumbnail_url" value="{{ old('thumbnail_url', $lesson->thumbnail_url) }}" required>
        </div>
